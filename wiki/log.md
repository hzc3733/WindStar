...
## [2026-05-13] ingest | 摄入 B 站视频知识库搭建教程

### 处理文件
- `raw/03-transcripts/2026-05-13-把B站视频转成本地AI知识库！新手也能3分钟上手.md`

### 创建的来源摘要（1 个）
- [[摘要-bilibili-ai-knowledge-base]] — B 站视频转本地 AI 知识库工具链教程

### 创建的实体页面（3 个）
- [[karpathy-llm-wiki-vault]] — Obsidian 知识库模板
- [[Obsidian]] — 本地双链笔记软件
- [[Bilibili_Web_Clipper]] — B 站专用网页剪藏扩展

### 更新文件
- [[index.md]] — 新增来源摘要和实体注册
